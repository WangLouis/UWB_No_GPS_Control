...
{
    public const string MAVLINK_BUILD_DATE = "Fri Jun 09 2017";
    ...
    public static readonly message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
		...
		new message_info(195, "CELLULAR_STATUS", 111, 6, 6, typeof( mavlink_cellular_status_t )),
...
ADAP_TUNING = 11010,
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=6)]
    ///<summary> cellular network status </summary>
    public struct mavlink_cellular_status_t
    {
        /// <summary> cellular network technology </summary>
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=5)]
		public byte[] technology;
            /// <summary> cellular network signal RSSI </summary>
        public  byte rssi;
